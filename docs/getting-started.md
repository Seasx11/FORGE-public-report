<sub>[Documentation](README.md) › Getting started</sub>

# Getting started

This guide takes a new shop from its first sign-in to a customer-approved quote. It takes about five minutes. You need a FORGE invitation for your shop and a current web browser.

## 1. Sign in

Open the invitation link for your shop and sign in with the email address and password for your account.

<img src="../assets/screenshots/sign-in.png" alt="The FORGE sign-in page with email and password fields." width="100%">
...
<img src="../assets/demo/new-job.gif" alt="A staff member opens a new job, chooses the customer, sets a due date and next action, and saves it." width="100%">
...
<img src="../assets/demo/quote.gif" alt="A staff member drafts a quote for block machining, saves it as revision 1 and issues it to the customer." width="100%">
...
<img src="../assets/demo/customer-approval.gif" alt="A customer signs in, opens their engine job, reviews the issued quote and approves it." width="100%">
