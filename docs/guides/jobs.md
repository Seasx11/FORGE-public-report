<sub>[Documentation](../README.md) › [Guides](../README.md#guides) › Jobs</sub>

# Jobs

A job is one piece of work for one customer. This guide covers opening a job, keeping it current and finding it again.

<img src="../../assets/guides/jobs.png" alt="The FORGE job list with counts of active jobs, jobs waiting on parts and jobs ready for pickup." width="100%">
