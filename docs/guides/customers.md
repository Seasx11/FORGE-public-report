<sub>[Documentation](../README.md) › [Guides](../README.md#guides) › Customers</sub>

# Customers

Customers are the people and businesses your shop does work for. Every job belongs to one customer.

<img src="../../assets/guides/customers.png" alt="The FORGE customer list with names, companies and email addresses." width="100%">
...
<img src="../../assets/guides/customer-view.png" alt="The customer's view of a job with its status and an approved quote." width="100%">
...
<img src="../../assets/guides/customer-mobile.png" alt="The customer's view of a job on a phone." width="280">
